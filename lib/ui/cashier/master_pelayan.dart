...
import 'add_pelayan.dart' as addPage;
import 'show_pelayan.dart' as showPage;
// import '../home.dart';
// import 'modelSupplier.dart';

import 'package:shared_preferences/shared_preferences.dart';
import '../drawerBar.dart';
void main() => runApp(MasterPelayanPage());
...
class MasterPelayanPage extends StatefulWidget {
  final String email,passwordValue;

  MasterPelayanPage({Key key, this.email, this.passwordValue}) : super(key: key);

  @override
  _MasterPelayanPageState createState() => _MasterPelayanPageState();
}
...
class _MasterPelayanPageState extends State<MasterPelayanPage> with SingleTickerProviderStateMixin
{
