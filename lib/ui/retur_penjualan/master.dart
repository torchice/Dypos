...
void main() => runApp(MasterReturPenjualanPage());
...
class MasterReturPenjualanPage extends StatefulWidget {
  final String email,passwordValue;

  MasterReturPenjualanPage({Key key, this.email, this.passwordValue}) : super(key: key);

  @override
  _MasterReturPenjualanPageState createState() => _MasterReturPenjualanPageState();
}
...
class _MasterReturPenjualanPageState extends State<MasterReturPenjualanPage> with SingleTickerProviderStateMixin
{
 ...
 _loadUid() async {             
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        ...
        title:     
          InkWell(
            child:  new Text('Master Retur Penjualan'),
            onTap:(){
                Navigator.push(
                    context,
        ...
        bottom: new TabBar(
          ...
          tabs: <Tab>[
            new Tab(icon: new Icon(Icons.home), text: "List Transaction",),
