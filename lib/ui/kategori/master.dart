...
void main() => runApp(MasterKategoriPage());
...
class MasterKategoriPage extends StatefulWidget {
  final String email,passwordValue;

  MasterKategoriPage({Key key, this.email, this.passwordValue}) : super(key: key);

  @override
  _MasterKategoriPageState createState() => _MasterKategoriPageState();
}
...
class _MasterKategoriPageState extends State<MasterKategoriPage> with SingleTickerProviderStateMixin
{
 ...
 _loadUid() async {             
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        ...
        title:     
          InkWell(
            child:  new Text('Master Kategori'),
            onTap:(){
                Navigator.push(
                    context,
