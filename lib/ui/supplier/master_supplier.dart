...
void main() => runApp(MasterSupplierPage());
...
class MasterSupplierPage extends StatefulWidget {
  ...
  MasterSupplierPage({Key key, this.email, this.passwordValue}) : super(key: key);
...
class _MasterSupplierPageState extends State<MasterSupplierPage> with SingleTickerProviderStateMixin
{
