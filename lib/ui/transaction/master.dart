...
void main() => runApp(MasterTransListPage());
...
class MasterTransListPage extends StatefulWidget {
  final String email,passwordValue;

  MasterTransListPage({Key key, this.email, this.passwordValue}) : super(key: key);

  @override
  _MasterTransListPageState createState() => _MasterTransListPageState();
}
...
class _MasterTransListPageState extends State<MasterTransListPage> with SingleTickerProviderStateMixin
{
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      drawer:buildDrawer(context,idUser,_email,role),
        ...
        children: <Widget>[
          new showPage.ShowTrans(controller: controller,),
